...
echo ".hal = $LOCAL_RESULTDIR/$PREFIX.hal" >> $WORKDIR/$PREFIX.ragout.recipe
...
#    --synteny hal \
#    /workdir/$PREFIX.ragout.recipe 
PATH=$PATH:/home/shepperp/software/progressiveCactus/submodules/hal/bin    
/home/shepperp/software/Ragout/ragout.py --threads 10 \
          --outdir $WORKDIR \
          --synteny hal \
          $WORKDIR/$PREFIX.ragout.recipe
